...
public class IndexerOmimtxt {
	...
	Date start = new Date();
    final Path docDir = Paths.get("F:/Ecole(Telecom)/cours telecom/Projet_GMD/bases/omim.txt");
   ...
   try {
     ...
     Directory dir = FSDirectory.open(Paths.get("F:/Ecole(Telecom)/cours telecom/Projet_GMD/indexs/indexOmimtxt"));
