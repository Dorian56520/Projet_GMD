		      ...
		      // If that's not the case searching for special characters will fail.
		    	...
		    	while(line != null){
		    		...
		    		if (line.length() > 10){
		    			...
		    			if(line.substring(0,4).equals("xref")){
			    			//System.out.println("line 0 : 4 = " +line.substring(0,4));
			    			...
			    			if (line.length() > 10){
			    				while (line.substring(0,4).equals("xref")){
			    					if(line.substring(6,10).equals("UMLS")){
					    				//System.out.println("line 0 : 4 = " +line.substring(11,line.length()));
			    				...
			    				//doc.add(new TextField("CUI",xref,Field.Store.YES));	
		    		...
		    		doc.add(new StoredField("CUI",xref));
		    		doc.add(new StoredField("test","chameau"));
